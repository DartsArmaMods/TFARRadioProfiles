...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "trp_fnc_recompile") then {trp_recompiles = []; trp_fnc_recompile = {{call _x} forEach trp_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; trp_recompiles pushBack _recomp;
#else
